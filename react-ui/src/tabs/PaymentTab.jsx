...
<Document xmlns="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.14">
    <FIToFICstmrCdtTrf>
        ...
        <CdtTrfTxInf>
            ...
            <InstdAmt Ccy="${fields.InstdAmtCcy}">${fields.InstdAmt}</InstdAmt>
...
export default function PaymentTab({ onAddRow = () => {} }) {
    ...
    useEffect(() => {
        ...
        if (selectedCurrency === "DEUR" && !isOutbound) {
            ...
            newFields = paymentDetailsFieldsOutboundUsdcToEur;
        }
        setFields({
            ...baseFields,
            ...newFields
    ...
    const handleSubmit = async e => {
        ...
        if (showAdvanced) {
            ...
            const xml = buildPaymentDetailsXML(xmlFields);
            console.log(xml);
        ...
        <div className="pro-tab-root">
            ...
            >
                ...
                {showAdvanced && (
                    <>
                        <fieldset style={{border: "1px solid #e0e0e0", borderRadius: 8, marginBottom: 28, padding: 20}}>
                            <legend style={{fontWeight: 600, color: "#1976d2", padding: "0 10px"}}>Payment Details (ISO 20022)</legend>
                            <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18}}>
                                <Input label="Message ID" name="MsgId" value={fields.MsgId} onChange={handleChange}/>
                                <Input label="Creation Date/Time" name="CreDtTm" value={fields.CreDtTm} onChange={handleChange}/>
                                <Input label="Number of Transactions" name="NbOfTxs" value={fields.NbOfTxs} onChange={handleChange}/>
                                <Input label="Settlement Method" name="SttlmMtd" value={fields.SttlmMtd} onChange={handleChange}/>
                                <Input label="Instruction ID" name="InstrId" value={fields.InstrId} onChange={handleChange}/>
                                <Input label="EndToEnd ID" name="EndToEndId" value={fields.EndToEndId} onChange={handleChange}/>
                                ...
                                <Input label="Transaction Hash" name="TxHash" value={fields.TxHash} onChange={handleChange}/>
                                <Input label="Interbank Settlement Amount" name="IntrBkSttlmAmt" value={fields.IntrBkSttlmAmt} onChange={handleChange}/>
                                <Input label="Interbank Settlement Currency" name="IntrBkSttlmCcy" value={fields.IntrBkSttlmCcy} onChange={handleChange}/>
                                ...
                                <Input label="Remittance Information" name="RmtInfUstrd" value={fields.RmtInfUstrd} onChange={handleChange}/>
                            </div>
                        </fieldset>
                        ...
                        <fieldset style={{border: "1px solid #e0e0e0", borderRadius: 8, marginBottom: 28, padding: 20}}>
                            ...
                            <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18}}>
                                ...
                                <Input label="Debtor Wallet Address" name="DbtrWalletAddr" value={fields.DbtrWalletAddr} onChange={handleChange}/>
                                <Input label="Debtor Wallet Network" name="DbtrWalletNtwrk" value={fields.DbtrWalletNtwrk} onChange={handleChange}/>
                                <Input label="Debtor Token ID" name="DbtrTokenId" value={fields.DbtrTokenId} onChange={handleChange}/>
                                <Input label="Debtor Agent BIC" name="DbtrAgtBIC" value={fields.DbtrAgtBIC} onChange={handleChange}/>
                                <Input label="Debtor Agent LEI" name="DbtrAgtLEI" value={fields.DbtrAgtLEI} onChange={handleChange}/>
                            </div>
                        </fieldset>
                        ...
                        <fieldset style={{border: "1px solid #e0e0e0", borderRadius: 8, marginBottom: 28, padding: 20}}>
                            ...
                            <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18}}>
                                ...
                                <Input label="Creditor Wallet Address" name="CdtrWalletAddr" value={fields.CdtrWalletAddr} onChange={handleChange}/>
                                <Input label="Creditor Wallet Network" name="CdtrWalletNtwrk" value={fields.CdtrWalletNtwrk} onChange={handleChange}/>
                                <Input label="Creditor Token ID" name="CdtrTokenId" value={fields.CdtrTokenId} onChange={handleChange}/>
                                <Input label="Creditor Agent BIC" name="CdtrAgtBIC" value={fields.CdtrAgtBIC} onChange={handleChange}/>
                                <Input label="Creditor Agent LEI" name="CdtrAgtLEI" value={fields.CdtrAgtLEI} onChange={handleChange}/>
                            </div>
                        </fieldset>
                    </>
                )}
